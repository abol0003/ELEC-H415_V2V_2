...
class RayTracing:
    ...
    def __init__(self, environment):
        ...
        self.beta = (2 * np.pi * self.frequency) / 299792458
        c = 299792458
    ...
    def compute_electrical_field_and_power(self, coefficient, distance):
        ...
        Voltage =0.5*self.h_e*Elec_field
        ...
        for obstacle1 in self.environment.obstacles:
            ...
            for obstacle2 in self.environment.obstacles:
                ...
                #trois coeff transmission poss car 3 rayons
                        ...
                        print(f"Puissance reçue après réflexion (Obstacle {obstacle1}): {Power} W")
                        Volt_tot += Voltage
                        Power_tot += Power
                    ...
                    if obstacle3.check_intersection(image_pos3, receiver.position):
                        ...
                        if obstacle2.check_intersection(image_pos2, impact_point3):
                            ...
                            if obstacle1.check_intersection(image_pos1, impact_point2):
                                ...
                                # Trois coefficients de transmission, car il y a 3 rayons
                                ...
                                total_distance = self.calc_distance(emitter.position,
                                                                    impact_point1) + self.calc_distance(impact_point1,
                                                                                                        impact_point2) + self.calc_distance(
                                    impact_point2, impact_point3) + self.calc_distance(impact_point3, receiver.position)
